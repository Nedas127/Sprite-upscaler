...
# Funkcija duomenų nuskaitymui iš teksto failo
def parse_results_file(file_path):
    ...
    with open(file_path, 'r') as f:
        ...
        # Ieškome duomenų eilučių (po headerių)
        start_reading = False

        for line in lines:
            # Tikriname, ar eilutėje yra modelio duomenys
            if line.startswith('----'):
                start_reading = True
                continue
...
try:
    ...
    # Sutrumpiname modelių pavadinimus
